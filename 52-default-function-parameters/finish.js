 ...
 */
//const weatherForecast = (city, weather) => `Прогноз погоды для города ${city}: ${weather}`;
const weatherForecast = (city, weather = 'Отличная погода!') => `Прогноз погоды для города ${city}: ${weather}`;
